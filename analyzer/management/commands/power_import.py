...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        PRODUCTS_CSV = os.path.join(BASE_DIR, '../../../spider/cleaned/cleaned_power_products.csv')
        PRICE_HISTORY_CSV = os.path.join(BASE_DIR, '../../../spider/cleaned/cleaned_power_price_history.csv')
